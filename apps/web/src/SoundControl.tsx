...
import { applySound, type Channel, isSilent, loadSound, type SoundSettings } from './sound';
...
const icon = (silent: boolean) => (silent ? '/images/speaker-off.webp' : '/images/speaker-on.webp');
